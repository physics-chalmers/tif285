...
\paragraph{How will this course be different from a computer science class?}
...
\item Weak / varied background in traditional computer science core topics such as fundamental algorithms, databases, etc.
\end{itemize}
...
\begin{itemize}
  ...
  \item We have different priorities for judging a ``good'' method: interpretability, error estimates, etc.
\end{itemize}
...
\begin{itemize}
    ...
    \item Experiment / survey design.

    \item Optimization of statistical errors.

    \item Control of systematic errors.
